//picaGL stub so i can figure out if the game is lagging because of the darn opengl implementation or if it's due to the game itself
//dont forget to unlink -lpicaGL from the Makefile when using this
#undef OPENGLSTUB
//#define OPENGLSTUB
#ifdef OPENGLSTUB
#ifdef __cplusplus
...
void pglExit(){};
void pglSwapBuffers(){};
void pglSelectScreen(void*,void*){};
#include "GL/gl.h"
#include <stdio.h>
