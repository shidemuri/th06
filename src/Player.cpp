...
ChainCallbackResult Player::OnDrawHighPrio(Player *p)
{
    ...
    if (!g_GameManager.isInRetryMenu)
    {
            ...
            (p->playerState == PLAYER_STATE_ALIVE || p->playerState == PLAYER_STATE_INVULNERABLE))
        {
            ...
            x2 = p->orbsSprite[1].pos.x + g_GameManager.arcadeRegionTopLeftPos.x;
            y2 = p->orbsSprite[1].pos.y + g_GameManager.arcadeRegionTopLeftPos.y;
            memcpy(&p->orbsSprite[0].pos.x, &x1, sizeof(f32));
